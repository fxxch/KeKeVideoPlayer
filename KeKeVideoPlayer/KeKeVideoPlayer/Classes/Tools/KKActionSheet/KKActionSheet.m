...
- (instancetype)initWithTitle:(NSString *)aTitle
    ...
    if (self) {
        ...
        [self.cancelButton kk_setBackgroundColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [self.cancelButton kk_setBackgroundColor:[UIColor lightGrayColor] forState:UIControlStateHighlighted];
...
- (void)hide{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        [[UIWindow kk_currentKeyWindow] becomeKeyWindow];
...
- (CGFloat)setAllText{
    ...
    if ([NSString kk_isStringNotEmpty:self.myTitleString] &&
        ...
        CGSize titleSize = [UIFont kk_sizeOfFont:self.myTitleLabel.font];
    ...
    //只有副标题
        ...
        CGSize subTitleSize = [UIFont kk_sizeOfFont:self.mySubTitleLabel.font];
...
- (void)setAllButton:(CGFloat)yOffset{
    ...
    for (NSInteger i=0; i<[self.buttonTitlesArray count]; i++) {
        ...
        [button01 kk_setBackgroundColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [button01 kk_setBackgroundColor:[UIColor lightGrayColor] forState:UIControlStateHighlighted];
        button01.tag = 1101+i;
