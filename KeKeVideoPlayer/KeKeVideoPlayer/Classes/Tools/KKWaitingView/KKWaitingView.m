...
- (void)initUIWithCustomerView:(UIView*)aCustomerView{
    ...
    if (self.blackBackground) {
        ...
        CGSize size = [self.text kk_sizeWithFont:textFont maxSize:CGSizeMake(text_width, 1000)];
        ...
        UIColor *textColor = [UIColor whiteColor];
        UIFont  *textFont = [UIFont systemFontOfSize:15];
        CGSize  fontSize = [UIFont kk_sizeOfFont:textFont];
        CGSize  textSize = [self.text kk_sizeWithFont:textFont maxWidth:text_width];
        //文字长度超过一行
