...
- (void)initUI{
    ...
    CGSize size = [UIFont kk_sizeOfFont:TEXT_FONT];
    ...
    UIImage *image = [NSBundle kk_imageInBundle:@"KKScrollVewRefresh.bundle" imageName:@"blackArrow"];
...
- (void)reload{
    if (_refreshImageStyle==KKHPullRefreshImageStyle_Default) {
        UIImage *image = [NSBundle kk_imageInBundle:@"KKScrollVewRefresh.bundle" imageName:@"whiteArrow"];
        self.arrowImageView.image = image;
    }
        ...
        UIImage *image = [NSBundle kk_imageInBundle:@"KKScrollVewRefresh.bundle" imageName:@"blueArrow"];
        self.arrowImageView.image = image;
    }
    else if (_refreshImageStyle==KKHPullRefreshImageStyle_Gray){
        UIImage *image = [NSBundle kk_imageInBundle:@"KKScrollVewRefresh.bundle" imageName:@"grayArrow"];
        self.arrowImageView.image = image;
    }
...
- (void)reloadUIForState:(KKHPullRefreshState)state{
    ...
    switch (state) {
        case KKHPullRefreshState_Normal:{
            ...
            if ([NSString kk_isStringEmpty:text]) {
        ...
        case KKHPullRefreshState_Pulling:{
            ...
            if ([UIDevice kk_isSystemVersionBigerThan:@"10.0"]) {
